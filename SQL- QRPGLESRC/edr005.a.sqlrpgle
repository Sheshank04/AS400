     ...
     A* DESCRIPTION......: SQLRPGLE Update & Delete Using Cursor               //
     A* -----------------------------------------------------------------------//
     A* Modification Log                                                       //
     A* -----------------------------------------------------------------------//
...
**FREE
        ...
        Exec SQL
          DECLARE EmployeeCursor2 CURSOR FOR
            ...
            FROM EDPF001
            WHERE EMPID > 204
            FOR UPDATE OF EMPID, EMPNAME, EMPDEPT;
        ...
        // Fetch and delete  row
          Dow SqlCode = 0;
            Exec SQL FETCH EmployeeCursor2 into :EmployeeId, :EmployeeName, :EmployeeDept;

              Exec SQL
                DELETE FROM EDPF001
                WHERE CURRENT OF EmployeeCursor2;

          EndDo;
          dsply 'Delete Succesful';
        // Close cursor
        Exec SQL CLOSE EmployeeCurso2;
